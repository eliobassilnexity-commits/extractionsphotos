...
if st.session_state.uploaded_excel and st.session_state.uploaded_pdf:
    if st.button("🚀 Lancer l'extraction") or st.session_state.start_extraction:
        st.session_state.start_extraction = True  # Pour conserver l'état après rerun
        ...
        # --- Photos ---
        if st.session_state.progress_photos is None or st.session_state.progress_photos == 0:
        ...
        # --- Plans ---
        if st.session_state.progress_plans is None or st.session_state.progress_plans == 0:
